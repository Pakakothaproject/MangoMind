        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6">
                <div className="flex space-x-1 bg-gray-800 rounded-lg p-1">
                    {[
                        { id: 'chat', label: 'Chat Models', count: preferredModels.length },
                        { id: 'image', label: 'Image Models', count: preferredImageModels.length },
                        { id: 'video', label: 'Video Models', count: preferredVideoModels.length }
                    ].map(tab => (
                        <button
                            key={tab.id}
